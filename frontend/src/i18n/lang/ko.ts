...
export default {
  ...
  settings: {
    ...
    jtp2Threshold: "JTP2 태그 임계값",
    jtp2ThresholdTooltip: "태그 포함 신뢰도 임계값 (0.0 ~ 1.0)",
    jtp2ForceCpu: "JTP2 CPU 강제 사용",
    jtp2ForceCpuTooltip: "JTP2에서 GPU 대신 CPU를 강제로 사용",
    wdv3ModelName: "WDv3 모델",
    wdv3ModelNameTooltip: "WDv3 모델 아키텍처 선택 (ViT, SwinV2, 또는 ConvNext)",
    wdv3GenThreshold: "일반 태그 임계값",
    wdv3GenThresholdTooltip: "일반 태그의 신뢰도 임계값 (기본값: 0.35)",
    wdv3CharThreshold: "캐릭터 태그 임계값",
    wdv3CharThresholdTooltip: "캐릭터 태그의 신뢰도 임계값 (기본값: 0.75)",
    wdv3ConfigUpdateError: "WDv3 설정 업데이트 실패",
    wdv3ForceCpu: "WDv3 CPU 강제 사용",
    wdv3ForceCpuTooltip: "WDv3에서 GPU 대신 CPU를 강제로 사용",
