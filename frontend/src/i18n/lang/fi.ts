...
export default {
  ...
  gallery: {
    ...
    moveItemsDescription: (params: TranslationParams) => "Siirrä valitut kohteet toiseen kansioon",
    selectTargetFolder: "Valitse kohdekansio",
    searchFolders: "Etsi kansioita...",
    noFoldersFound: "Kansioita ei löytynyt",
    noFoldersAvailable: "Ei kansioita saatavilla",
    moveSuccess: "Siirto onnistui",
    moveSelected: "Siirrä valitut",
    moveError: "Virhe siirrossa",
