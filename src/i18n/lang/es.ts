...
export default {
  ...
  settings: {
    ...
    jtp2ModelPathTooltip: "Ruta al archivo del modelo JTP2",
    jtp2TagsPath: "Ruta de etiquetas JTP2",
    jtp2TagsPathTooltip: "Ruta al archivo de etiquetas JTP2",
    jtp2Threshold: "Umbral de etiquetas JTP2",
    jtp2ThresholdTooltip: "Umbral de confianza para incluir etiquetas (0.0 a 1.0)",
    jtp2ForceCpu: "Forzar CPU para JTP2",
    jtp2ForceCpuTooltip: "Forzar JTP2 a usar CPU en lugar de GPU",
    wdv3ModelName: "Modelo WDv3",
    wdv3ModelNameTooltip: "Seleccionar la arquitectura del modelo WDv3 (ViT, SwinV2 o ConvNext)",
    wdv3GenThreshold: "Umbral de etiquetas generales",
    wdv3GenThresholdTooltip: "Umbral de confianza para etiquetas generales (0.35 por defecto)",
    wdv3CharThreshold: "Umbral de etiquetas de personajes",
    wdv3CharThresholdTooltip: "Umbral de confianza para etiquetas de personajes (0.75 por defecto)",
    wdv3ForceCpu: "Forzar WDv3 en CPU",
    wdv3ForceCpuTooltip: "Forzar WDv3 a usar CPU en lugar de GPU",
    wdv3ConfigUpdateError: "Error al actualizar la configuración de WDv3",
