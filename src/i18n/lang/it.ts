...
export default {
  ...
  settings: {
    ...
    jtp2Threshold: "Soglia JTP2",
    jtp2ThresholdTooltip: "Soglia di confidenza per il rilevamento dei tag (0.0 - 1.0)",
    jtp2ForceCpu: "Forza CPU JTP2",
    jtp2ForceCpuTooltip: "Forza l'uso della CPU invece della GPU per il rilevamento dei tag",
    downloadModel: "Scarica modello (1,8 GB)",
    downloadTags: "Scarica tag (195 KB)",
    wdv3ModelName: "Modello WDv3",
    wdv3ModelNameTooltip: "Seleziona il modello WDv3 da utilizzare",
    wdv3GenThreshold: "Soglia generale WDv3",
    wdv3GenThresholdTooltip: "Soglia di confidenza generale per il rilevamento dei tag (0.0 - 1.0)",
